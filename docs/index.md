...
Hi! I'm Katrina, a researcher at Anthropic. I recently [graduated magna cum laude from Harvard University]({{ '/courses' | relative_url }}) ('25) with an undergraduate degree in Computer Science and Math, as well as a masters degree in Statistics. On campus, I conducted machine learning research, taught courses, and helped run the undergraduate Women in Computer Science (WiCS) group.
