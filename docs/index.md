...
I grew up in Indiana, and since then I've passed my time living in San Francisco, Cambridge MA, NYC, and Chicago. In my spare moments, I love to hike the trails of SF, road bike, run half-marathons, [read]({{ '/reading' | relative_url }}), and infuse baked goods and smoothies with vegetables. My creative side manifests in violin, which I studied seriously under Mimi Zweig at the IU Jacobs School of Music from 5-16 years old, and more sporadically since. 
